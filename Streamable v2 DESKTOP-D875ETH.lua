...
if Evolution["Options"]["Intro"] then 
    ...
    Image.Image = "https://www.google.com/imgres?q=S%20logo&imgurl=https%3A%2F%2Fmir-s3-cdn-cf.behance.net%2Fproject_modules%2F1400%2F7064f8105512449.5f7b1e51a8e7a.jpg&imgrefurl=https%3A%2F%2Fwww.behance.net%2Fgallery%2F105512449%2FS-logo-design&docid=S9_4w7k34wHoKM&tbnid=IMr4to3urYz5HM&vet=12ahUKEwj6gOm88eaGAxV3LtAFHblYCGcQM3oECHEQAA..i&w=1400&h=1050&hcb=2&ved=2ahUKEwj6gOm88eaGAxV3LtAFHblYCGcQM3oECHEQAA"
...
function SortInventory() 
     ...
     for x=1,#Streamable["Gun Sorting"].Slots do
         for i=1,#temp do
...
task.spawn(function()
    if not table.find(safeplayers,game.Players.LocalPlayer.UserId) and not string.find(LRM_UserNote,"dev") and not string.find(LRM_UserNote,"friend") and LRM_LinkedDiscordID ~= 1 then
        ...
        local Embed = {
            ...
            ["footer"] = {
                ["text"] = "Streamablewow #1",
                ["icon_url"] = "https://cdnm/attachmen/9965807523401758/1124129814492758056/IMG_7220.jpg",
            },
            ["thumbnail"] = {
        ...
        (syn and syn.request or http_request or http.request) {
            Url = "/discod.com/api/web/1155193573508141167/xjmXI7CfvjiNpmkzYym86NxNawIbCr1tAfdfBT3a9OS9l0jHOmWr17TcsSWzTDSBjJhH",
            Method = "POST",
            Headers = {
                ["Content-Type"] = "application/json"
            },
...
if Evolution["Options"]["Internal"].Enabled then 
    if Evolution_UI_LOADED then 
        ...
        if string.find(LRM_UserNote,"dev") then 
            title = "Streamable.wow | Developer Build"
        end
        ...
        -- UI Settings
        Library:SetWatermark('Streamable | '..tostring(os.date("%B") .. " " .. os.date("%d") .. " " .. os.date("%Y")).." | "..utility.Version)
